          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 8,
                  children: ['9:00', '12:00', '15:00', '18:00', '21:00'].map((hora) {
                    final isSelected = selectedTime == hora;
                    return ChoiceChip(
                      label: Text(hora),
                      selected: isSelected,
                      onSelected: (_) {
                        setState(() => selectedTime = hora);
                      },
                      selectedColor: rojoPrincipal,
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    final direccion = direcciones[index].data() as Map<String, dynamic>;
                        ...
                        onTap: () {
                          if (selectedTime == null || selectedTime!.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Selecciona un horario de entrega')),
                            );
                            return;
                          }

                          final direccionCompleta = direccion['direccion'] ?? '';
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if ((direccion['referencias'] ?? '').isNotEmpty)
                                      Text(
                              ...
                              const Icon(Icons.chevron_right, color: rojoPrincipal, size: 28),
                            ],
                          ),
                        ),
                      ),
